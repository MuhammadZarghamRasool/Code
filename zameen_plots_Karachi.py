...
itr=0
while itr != "404":
    pagelink=requests.get(f'https://www.zameen.com/Plots/Karachi-2-{i}.html')
...
sql = '''INSERT INTO zameen_rental (image, title, price, bed, area, location, city, type, category) VALUES(?,?,?,?, ?, ?, ?, ?, ?)'''
