...
# itr=0
# while j != 99:
link=requests.get("https://www.graana.com/residential/for_rent/karachi/all/1?offset=2670&page=90")
...
for all_data in all:
    ...
    #bed=all_data.find(class_="col-12 style_tileTitle__R0NOB").find('span').text
