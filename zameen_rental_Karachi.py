...
while itr != "404":
    pagelink=requests.get(f'https://www.zameen.com/Rentals/Karachi-2-{i}.html')
    ...
    for all_data in allAds:
        ...
        city="Karachi"
        category="Rental"
        ads_list[count]=[tittle,image,price,beds,area,location,city,type,category]
        count+=1

sql = '''INSERT INTO zameen_rental (image, title, price, bed, area, location) VALUES(?, ?, ?, ?, ?, ?)'''
